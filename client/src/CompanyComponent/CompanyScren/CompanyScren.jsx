...
export default function CompanyScren({ setUserData, getUserNot }) {
    ...
    async function handleUpdate(values) {
        ...
        await axios.patch(`${process.env.REACT_APP_API}/company/updateEmployee/${values._id}`, {
            name: values.name,
    ...
    async function handlePassUpdate(values) {
        ...
        await axios.patch(`${process.env.REACT_APP_API}/company/resetEmployeePasswordByCompany/${values._id}`, {
    ...
    async function deleteEmploye(_id) {
        ...
        await axios.delete(`${process.env.REACT_APP_API}/company/deleteEmployee/${_id}`, { headers }).catch((err) => {
            if (err?.response?.status == 401) {
                console.log(err);
                localStorage.clear()
                setUserData(null)
                ...
                <div className='col-xl-4 col-lg-6 col-md-8 col-10 formRes'>
                    <form onSubmit={formik2.handleSubmit} className='w-100 my-5  p-5 bg-light rounded-3 shadow mainFont'>
                        ...
                        <div className='row my-2 g-3'>
                            ...
                            <button onClick={() => { setResetPassMood(false) }} type='reset' className='btn mx-auto btn-outline-danger col-12 rounded-pill '>cancel</button>
                ...
                : <>
                    ...
                    <div className='w-75 mx-auto row align-items-center justify-content-around '>
                        ...
                        <div className='col-md-7'>
                            <div className=''>
                                <h5 className='fw-bold' >Company Name : <span className='text-muted'>{CompanyData?.name}</span> </h5>

                                <h5 className='fw-bold'>About : <span className='text-muted'>{CompanyData?.about}</span></h5>

                            </div>
                        </div>
                    </div>
                    <h2 className='text-center mainFont h1 mt-3'>Employees</h2>
                            ...
                            {CompanyEmployes?.length != 0 ? <>
                                <div className=''>
                                    <div className='table-responsive'>
                                        <table className="table table-striped table-hover text-center py-5  ">
                                            <thead >
                                                <tr >
                                ...
                                <Link to='/addEmploye' className='btn mainBtn rounded-pill my-2 col-md-4 mx-auto '>Add Employe</Link>
                            </div>}
                        </>
